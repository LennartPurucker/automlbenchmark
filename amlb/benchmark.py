...
class TaskConfig:
    ...
    def __setattr__(self, name, value):
        if name == 'metrics':
            ...
            self.job_timeout_seconds = value * 12 + inference_time_extension  # Custom timeout value
                # min(value * 2 + inference_time_extension, value + rconfig().benchmarks.overhead_time_seconds + inference_time_extension))
